...
public class GrossWages2 {
    ...
    public static void countryWage(double hours) {
        ...
        if (hours > 40) {
            ...
            grossWageCAN = hours * 14;
            grossWageUS = hours * 15.84;
        }
        //others
        grossWageBG = hours * 0.15;
        grossWageCH = hours * 1.77;
        grossWageDR = hours * 1.60;
        grossWageHT = hours * 0.55;
